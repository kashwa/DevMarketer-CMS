  ...
  <div class="slug-widget">
    ...
    <div class="button-wrapper wrapper">
      ...
      <b-dropdown hoverable v-show="!isEditing && slug.length &gt; 1">
        ...
        <b-dropdown-item @click="copyToClipboard(fullUrl)" style="font-size: 0.8em;"><i class="fa fa-copy m-r-5" size="is-small"></i>Copy Full Url</b-dropdown-item>

        <b-dropdown-item @click="copyToClipboard(slug)" style="font-size: 0.8em;"><i class="fa fa-copy m-r-5" size="is-small"></i>  Copy Slug</b-dropdown-item>

        <b-dropdown-item has-link style="font-size: 0.8em;">
          <a :href="fullUrl" target="_blank">
            <i class="fa fa-link m-r-5" size="is-small"></i>
             Visit Url
          </a>
        </b-dropdown-item>
      </b-dropdown>
